      ...
      // Normal direct answer for the expected contact field
        ...
        if (inquiryResult.isCancelled) {
          ...
          const inquiry = (inquiryResult as any).inquiry || await InquiryService.create({
            ...
            service: dataObj.service || dataObj.serviceType || dataObj.websiteType || dataObj['visitor.service'] || (activeInquiry.industry ? `${activeInquiry.industry} booking` : 'chat_inquiry'),
            details,
